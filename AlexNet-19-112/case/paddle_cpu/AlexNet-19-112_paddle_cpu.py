...
class Model_1715451083(nn.Layer):
    def __init__(self):
        super(Model_1715451083, self).__init__()
...
def train(inp, label):
    model = Model_1715451083().to('cpu')
    initialize(model)
    my_input = paddle.to_tensor(inp).to('cpu')
